...
class TestSampleSizeEndpoint:
    ...
    def test_sample_size_with_defaults(self, client):
        ...
        response = client.post(
            "/sample-size", json={"baselinePct": 10.0, "comparisonPct": 12.0}
        )
    ...
    def test_sample_size_one_sided_matches_power(self, client):
        ...
        two_sided_resp = client.post(
            "/sample-size", json={**params, "alternative": "two-sided"}
        )
        one_sided_resp = client.post(
            "/sample-size", json={**params, "alternative": "greater"}
        )
...
class TestIntegration:
    ...
    def test_consistency_across_endpoints(self, client):
        ...
        sample_response = client.post("/sample-size", json={**params, "power": 0.8})
            ...
            json={
                **params,
                "sampleSizePerVariant": int(
                    sample_response.json()["sampleSizePerVariant"]
                ),
                "alternative": "two-sided",
            },
        )
